...
from analysis import output_error_wisdom
from analysis import output_error_od
...
# cms
def get_wisdom_cms():
    wisdom_cms = output_error_wisdom.WISDOM_ERROR_CMS
    cms_re = []
    cms_mse = []
    for i in range(4):
        tmp = 0
...
# fcs
def get_wisdom_fcs():
    wisdom_fcs = output_error_wisdom.WISDOM_ERROR_FCS
    fcs_re = []
    fcs_mse = []
    for i in range(4):
        tmp = 0
...
# cs
def get_wisdom_cs():
    wisdom_cs = output_error_wisdom.WISDOM_ERROR_CS
    cs_re = []
    cs_mse = []
    for i in range(4):
        tmp = 0
...
# fas
def get_wisdom_fas():
    wisdom_fas = output_error_wisdom.WISDOM_ERROR_FAS
    fas_re = []
    fas_mse = []
    for i in range(4):
        tmp = 0
...
def get_od_cms(ele_num):
    od_cms = output_error_od.OD_ERROR_CMS
    cms_re = []
    cms_mse = []
...
def get_od_fcs(ele_num):
    od_fcs = output_error_od.OD_ERROR_FCS
    fcs_re = []
    fcs_mse = []
    od_keys = get_top_k(ele_num)
    for i in range(4):
...
def get_od_cs(ele_num):
    od_cs = output_error_od.OD_ERROR_CS
    cs_re = []
    cs_mse = []
    od_keys = get_top_k(ele_num)
    for i in range(4):
...
def get_od_fas(ele_num):
    od_fas = output_error_od.OD_ERROR_FAS
    fas_re = []
    fas_mse = []
    od_keys = get_top_k(ele_num)
    for i in range(4):
